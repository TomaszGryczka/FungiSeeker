...
public class MushroomLabels {
    ...
    public static Map<Long, MushroomLabel> mushrooms = new HashMap<>() {{
        ...
        put(61L, MushroomLabel.builder().label("macrolepiota_procera").translation("Czubajka kania").score(Score.INEDIBLE).edibility(Edibility.INEDIBLE).build());
        ...
        put(65L, MushroomLabel.builder().label("boletus_edulis").translation("Borowik szlachetny").score(Score.INEDIBLE).edibility(Edibility.INEDIBLE).build());
        ...
        put(68L, MushroomLabel.builder().label("kuehneromyces_mutabilis").translation("Łuskwiak zmienny").score(Score.INEDIBLE).edibility(Edibility.INEDIBLE).build());
        ...
        put(71L, MushroomLabel.builder().label("stropharia_aeruginosa").translation("Pierścieniak grynszpanowy").score(Score.INEDIBLE).edibility(Edibility.INEDIBLE).build());
        ...
        put(73L, MushroomLabel.builder().label("boletus_reticulatus").translation("Borowik usiatkowany").score(Score.INEDIBLE).edibility(Edibility.INEDIBLE).build());
        put(74L, MushroomLabel.builder().label("coprinellus_disseminatus").translation("Czernidłak gromadny").score(Score.INEDIBLE).edibility(Edibility.INEDIBLE).build());
        ...
        put(76L, MushroomLabel.builder().label("lactarius_deliciosus").translation("Mleczaj rydz").score(Score.INEDIBLE).edibility(Edibility.INEDIBLE).build());
        ...
        put(79L, MushroomLabel.builder().label("suillus_granulatus").translation("Maślak ziarnisty").score(Score.INEDIBLE).edibility(Edibility.INEDIBLE).build());
        ...
        put(81L, MushroomLabel.builder().label("coprinellus_micaceus").translation("Czernidłak błyszczący").score(Score.INEDIBLE).edibility(Edibility.INEDIBLE).build());
        ...
        put(86L, MushroomLabel.builder().label("suillus_grevillei").translation("Maślak żółty").score(Score.INEDIBLE).edibility(Edibility.INEDIBLE).build());
        ...
        put(93L, MushroomLabel.builder().label("suillus_luteus").translation("Maślak zwyczajny").score(Score.INEDIBLE).edibility(Edibility.INEDIBLE).build());
        ...
        put(95L, MushroomLabel.builder().label("coprinus_comatus").translation("Czernidłak kołpakowaty").score(Score.INEDIBLE).edibility(Edibility.INEDIBLE).build());
        ...
        put(99L, MushroomLabel.builder().label("pleurotus_ostreatus").translation("Boczniak ostrygowaty").score(Score.INEDIBLE).edibility(Edibility.INEDIBLE).build());
